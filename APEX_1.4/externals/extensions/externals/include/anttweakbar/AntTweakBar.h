...
TW_API void     TW_CALL TwMeasureText(int *_Width, int *_Height);
TW_API void     TW_CALL TwMeasureTextLine(const char *_TextLine, int *_Width, int *_Height);
TW_API void     TW_CALL TwMoveText(int _X, int _Y);
TW_API void     TW_CALL TwCancelText();

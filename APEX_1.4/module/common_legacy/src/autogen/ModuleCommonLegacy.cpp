...
public:
	...
	ModuleCommonLegacy(ApexSDKIntl* inSdk)
	{
  	  mName = "Common_Legacy";
	  mSdk = inSdk;
	  mApiProxy = this;
	  ModuleCommonLegacyRegistration::invokeRegistration(mSdk->getParameterizedTraits());
	}

protected:
	void releaseLegacyObjects()
        {
          ModuleCommonLegacyRegistration::invokeUnregistration(mSdk->getParameterizedTraits());
        }
};
...
void instantiateModuleCommonLegacy()
{
	...
	ModuleCommonLegacy *impl = PX_NEW(ModuleCommonLegacy)(sdk);

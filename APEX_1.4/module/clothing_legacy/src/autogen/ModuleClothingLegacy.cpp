...
#include "ModuleClothingLegacyRegistration.h"
...
public:
	...
	ModuleClothingLegacy(ApexSDKIntl* inSdk)
	{
  	  mName = "Clothing_Legacy";
	  mSdk = inSdk;
	  mApiProxy = this;
	  ModuleClothingLegacyRegistration::invokeRegistration(mSdk->getParameterizedTraits());
	}

protected:
	void releaseLegacyObjects()
        {
          ModuleClothingLegacyRegistration::invokeUnregistration(mSdk->getParameterizedTraits());
        }
};
